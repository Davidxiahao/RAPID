...
@androidx.annotation.RecentlyNonNull public final java.util.List<android.print.PrinterInfo> getPrinters() { throw new RuntimeException("Stub!"); }
...
public final void addPrinters(@androidx.annotation.RecentlyNonNull java.util.List<android.print.PrinterInfo> printers) { throw new RuntimeException("Stub!"); }
...
public final void removePrinters(@androidx.annotation.RecentlyNonNull java.util.List<android.print.PrinterId> printerIds) { throw new RuntimeException("Stub!"); }
...
public abstract void onStartPrinterDiscovery(@androidx.annotation.RecentlyNonNull java.util.List<android.print.PrinterId> priorityList);
...
public abstract void onValidatePrinters(@androidx.annotation.RecentlyNonNull java.util.List<android.print.PrinterId> printerIds);
...
public abstract void onStartPrinterStateTracking(@androidx.annotation.RecentlyNonNull android.print.PrinterId printerId);
...
public void onRequestCustomPrinterIcon(@androidx.annotation.RecentlyNonNull android.print.PrinterId printerId, @androidx.annotation.RecentlyNonNull android.os.CancellationSignal cancellationSignal, @androidx.annotation.RecentlyNonNull android.printservice.CustomPrinterIconCallback callback) { throw new RuntimeException("Stub!"); }
...
public abstract void onStopPrinterStateTracking(@androidx.annotation.RecentlyNonNull android.print.PrinterId printerId);
...
@androidx.annotation.RecentlyNonNull public final java.util.List<android.print.PrinterId> getTrackedPrinters() { throw new RuntimeException("Stub!"); }
