...
@Deprecated public NdefRecord(byte[] data) throws android.nfc.FormatException { throw new RuntimeException("Stub!"); }
...
@Deprecated public byte[] toByteArray() { throw new RuntimeException("Stub!"); }
