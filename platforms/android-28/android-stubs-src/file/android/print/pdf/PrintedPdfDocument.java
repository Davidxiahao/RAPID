...
public PrintedPdfDocument(@androidx.annotation.RecentlyNonNull android.content.Context context, @androidx.annotation.RecentlyNonNull android.print.PrintAttributes attributes) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.graphics.pdf.PdfDocument.Page startPage(int pageNumber) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.graphics.Rect getPageContentRect() { throw new RuntimeException("Stub!"); }
}
