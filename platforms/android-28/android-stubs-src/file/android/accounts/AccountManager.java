 ...
 *
 * Requires {@link android.Manifest.permission#AUTHENTICATE_ACCOUNTS}
...
@androidx.annotation.RecentlyNonNull public android.accounts.Account[] getAccounts() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.accounts.Account[] getAccountsByTypeForPackage(java.lang.String type, java.lang.String packageName) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.accounts.Account[] getAccountsByType(java.lang.String type) { throw new RuntimeException("Stub!"); }
 ...
 *
 * Requires {@link android.Manifest.permission#MANAGE_ACCOUNTS}
...
@Deprecated public android.accounts.AccountManagerFuture<java.lang.Boolean> removeAccount(android.accounts.Account account, android.accounts.AccountManagerCallback<java.lang.Boolean> callback, android.os.Handler handler) { throw new RuntimeException("Stub!"); }
 ...
 *
 * Requires {@link android.Manifest.permission#MANAGE_ACCOUNTS} or {@link android.Manifest.permission#USE_CREDENTIALS}
 ...
 * this function in API level 22.
 *
 * Requires {@link android.Manifest.permission#USE_CREDENTIALS}
...
@Deprecated public android.accounts.AccountManagerFuture<android.os.Bundle> getAuthToken(android.accounts.Account account, java.lang.String authTokenType, boolean notifyAuthFailure, android.accounts.AccountManagerCallback<android.os.Bundle> callback, android.os.Handler handler) { throw new RuntimeException("Stub!"); }
