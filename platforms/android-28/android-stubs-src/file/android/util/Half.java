...
public Half(@androidx.annotation.RecentlyNonNull java.lang.String value) throws java.lang.NumberFormatException { throw new RuntimeException("Stub!"); }
...
public int compareTo(@androidx.annotation.RecentlyNonNull android.util.Half h) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.util.Half valueOf(short h) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.util.Half valueOf(float f) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.util.Half valueOf(@androidx.annotation.RecentlyNonNull java.lang.String s) { throw new RuntimeException("Stub!"); }
...
public static short parseHalf(@androidx.annotation.RecentlyNonNull java.lang.String s) throws java.lang.NumberFormatException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static java.lang.String toString(short h) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static java.lang.String toHexString(short h) { throw new RuntimeException("Stub!"); }
