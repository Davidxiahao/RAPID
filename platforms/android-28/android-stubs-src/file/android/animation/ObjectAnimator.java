...
public void setPropertyName(@androidx.annotation.RecentlyNonNull java.lang.String propertyName) { throw new RuntimeException("Stub!"); }
...
public void setProperty(@androidx.annotation.RecentlyNonNull android.util.Property property) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public java.lang.String getPropertyName() { throw new RuntimeException("Stub!"); }
...
@java.lang.SafeVarargs public static <T> android.animation.ObjectAnimator ofMultiInt(java.lang.Object target, java.lang.String propertyName, android.animation.TypeConverter<T, int[]> converter, android.animation.TypeEvaluator<T> evaluator, T... values) { throw new RuntimeException("Stub!"); }
...
@java.lang.SafeVarargs public static <T> android.animation.ObjectAnimator ofMultiFloat(java.lang.Object target, java.lang.String propertyName, android.animation.TypeConverter<T, float[]> converter, android.animation.TypeEvaluator<T> evaluator, T... values) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.animation.ObjectAnimator ofObject(java.lang.Object target, java.lang.String propertyName, @androidx.annotation.RecentlyNullable android.animation.TypeConverter<android.graphics.PointF, ?> converter, android.graphics.Path path) { throw new RuntimeException("Stub!"); }
...
@java.lang.SafeVarargs @androidx.annotation.RecentlyNonNull public static <T, V> android.animation.ObjectAnimator ofObject(T target, android.util.Property<T, V> property, android.animation.TypeEvaluator<V> evaluator, V... values) { throw new RuntimeException("Stub!"); }
...
@java.lang.SafeVarargs @androidx.annotation.RecentlyNonNull public static <T, V, P> android.animation.ObjectAnimator ofObject(T target, android.util.Property<T, P> property, android.animation.TypeConverter<V, P> converter, android.animation.TypeEvaluator<V> evaluator, V... values) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static <T, V> android.animation.ObjectAnimator ofObject(T target, @androidx.annotation.RecentlyNonNull android.util.Property<T, V> property, @androidx.annotation.RecentlyNullable android.animation.TypeConverter<android.graphics.PointF, V> converter, android.graphics.Path path) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.animation.ObjectAnimator ofPropertyValuesHolder(java.lang.Object target, android.animation.PropertyValuesHolder... values) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.animation.ObjectAnimator setDuration(long duration) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public java.lang.Object getTarget() { throw new RuntimeException("Stub!"); }

/**
 * @param target This value may be {@code null}.
 */

public void setTarget(@androidx.annotation.RecentlyNullable java.lang.Object target) { throw new RuntimeException("Stub!"); }
