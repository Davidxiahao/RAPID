...
@Deprecated public CursorWindow(boolean localWindow) { throw new RuntimeException("Stub!"); }
...
@Deprecated public boolean isNull(int row, int column) { throw new RuntimeException("Stub!"); }
...
@Deprecated public boolean isBlob(int row, int column) { throw new RuntimeException("Stub!"); }
...
@Deprecated public boolean isLong(int row, int column) { throw new RuntimeException("Stub!"); }
...
@Deprecated public boolean isFloat(int row, int column) { throw new RuntimeException("Stub!"); }
...
@Deprecated public boolean isString(int row, int column) { throw new RuntimeException("Stub!"); }
