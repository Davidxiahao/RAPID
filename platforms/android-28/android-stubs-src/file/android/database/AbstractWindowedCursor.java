...
@Deprecated public boolean isBlob(int columnIndex) { throw new RuntimeException("Stub!"); }

/**
 * @deprecated Use {@link #getType}
 */

@Deprecated public boolean isString(int columnIndex) { throw new RuntimeException("Stub!"); }

/**
 * @deprecated Use {@link #getType}
 */

@Deprecated public boolean isLong(int columnIndex) { throw new RuntimeException("Stub!"); }

/**
 * @deprecated Use {@link #getType}
 */

@Deprecated public boolean isFloat(int columnIndex) { throw new RuntimeException("Stub!"); }
