...
@Deprecated public KeyEvent(android.view.KeyEvent origEvent, long eventTime, int newRepeat) { throw new RuntimeException("Stub!"); }
...
@Deprecated public boolean getKeyData(android.view.KeyCharacterMap.KeyData results) { throw new RuntimeException("Stub!"); }
...
@Deprecated public final boolean dispatch(android.view.KeyEvent.Callback receiver) { throw new RuntimeException("Stub!"); }
...
public static final int ACTION_MULTIPLE = 2; // 0x2
