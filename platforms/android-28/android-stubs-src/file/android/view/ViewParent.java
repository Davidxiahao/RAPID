...
public default void onDescendantInvalidated(@androidx.annotation.RecentlyNonNull android.view.View child, @androidx.annotation.RecentlyNonNull android.view.View target) { throw new RuntimeException("Stub!"); }
...
@Deprecated public void invalidateChild(android.view.View child, android.graphics.Rect r);
...
@Deprecated public android.view.ViewParent invalidateChildInParent(int[] location, android.graphics.Rect r);
...
public void notifySubtreeAccessibilityStateChanged(android.view.View child, @androidx.annotation.RecentlyNonNull android.view.View source, int changeType);
