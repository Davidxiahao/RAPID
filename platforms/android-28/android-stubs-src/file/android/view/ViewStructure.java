...
public void setTextIdEntry(@androidx.annotation.RecentlyNonNull java.lang.String entryName) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public abstract android.view.autofill.AutofillId getAutofillId();
...
public abstract void setAutofillId(@androidx.annotation.RecentlyNonNull android.view.autofill.AutofillId id);
...
public abstract void setAutofillId(@androidx.annotation.RecentlyNonNull android.view.autofill.AutofillId parentId, int virtualId);
...
public abstract void setAutofillHints(@androidx.annotation.RecentlyNullable java.lang.String[] hint);
...
public abstract void setWebDomain(@androidx.annotation.RecentlyNullable java.lang.String domain);
...
public abstract android.view.ViewStructure.HtmlInfo.Builder newHtmlInfoBuilder(@androidx.annotation.RecentlyNonNull java.lang.String tagName);
...
public abstract void setHtmlInfo(@androidx.annotation.RecentlyNonNull android.view.ViewStructure.HtmlInfo htmlInfo);
/**
...
@androidx.annotation.RecentlyNonNull public abstract java.lang.String getTag();
...
@androidx.annotation.RecentlyNullable public abstract java.util.List<android.util.Pair<java.lang.String, java.lang.String>> getAttributes();
/**
...
public abstract android.view.ViewStructure.HtmlInfo.Builder addAttribute(@androidx.annotation.RecentlyNonNull java.lang.String name, @androidx.annotation.RecentlyNonNull java.lang.String value);
