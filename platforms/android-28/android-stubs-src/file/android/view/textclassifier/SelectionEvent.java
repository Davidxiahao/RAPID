...
SelectionEvent(android.os.Parcel in) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.view.textclassifier.SelectionEvent createSelectionStartedEvent(int invocationMethod, int start) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.view.textclassifier.SelectionEvent createSelectionModifiedEvent(int start, int end) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.view.textclassifier.SelectionEvent createSelectionModifiedEvent(int start, int end, @androidx.annotation.RecentlyNonNull android.view.textclassifier.TextClassification classification) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.view.textclassifier.SelectionEvent createSelectionModifiedEvent(int start, int end, @androidx.annotation.RecentlyNonNull android.view.textclassifier.TextSelection selection) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.view.textclassifier.SelectionEvent createSelectionActionEvent(int start, int end, int actionType) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.view.textclassifier.SelectionEvent createSelectionActionEvent(int start, int end, int actionType, @androidx.annotation.RecentlyNonNull android.view.textclassifier.TextClassification classification) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public java.lang.String getEntityType() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public java.lang.String getResultId() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.view.textclassifier.TextClassificationSessionId getSessionId() { throw new RuntimeException("Stub!"); }
