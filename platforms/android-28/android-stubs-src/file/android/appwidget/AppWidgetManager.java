...
public void updateAppWidgetProviderInfo(android.content.ComponentName provider, @androidx.annotation.RecentlyNullable java.lang.String metaDataKey) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public java.util.List<android.appwidget.AppWidgetProviderInfo> getInstalledProvidersForProfile(@androidx.annotation.RecentlyNullable android.os.UserHandle profile) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public java.util.List<android.appwidget.AppWidgetProviderInfo> getInstalledProvidersForPackage(@androidx.annotation.RecentlyNonNull java.lang.String packageName, @androidx.annotation.RecentlyNullable android.os.UserHandle profile) { throw new RuntimeException("Stub!"); }
...
public boolean requestPinAppWidget(@androidx.annotation.RecentlyNonNull android.content.ComponentName provider, @androidx.annotation.RecentlyNullable android.os.Bundle extras, @androidx.annotation.RecentlyNullable android.app.PendingIntent successCallback) { throw new RuntimeException("Stub!"); }
