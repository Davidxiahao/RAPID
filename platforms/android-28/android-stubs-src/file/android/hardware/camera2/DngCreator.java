...
public DngCreator(@androidx.annotation.RecentlyNonNull android.hardware.camera2.CameraCharacteristics characteristics, @androidx.annotation.RecentlyNonNull android.hardware.camera2.CaptureResult metadata) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.hardware.camera2.DngCreator setOrientation(int orientation) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.hardware.camera2.DngCreator setThumbnail(@androidx.annotation.RecentlyNonNull android.graphics.Bitmap pixels) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.hardware.camera2.DngCreator setThumbnail(@androidx.annotation.RecentlyNonNull android.media.Image pixels) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.hardware.camera2.DngCreator setLocation(@androidx.annotation.RecentlyNonNull android.location.Location location) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.hardware.camera2.DngCreator setDescription(@androidx.annotation.RecentlyNonNull java.lang.String description) { throw new RuntimeException("Stub!"); }
...
public void writeInputStream(@androidx.annotation.RecentlyNonNull java.io.OutputStream dngOutput, @androidx.annotation.RecentlyNonNull android.util.Size size, @androidx.annotation.RecentlyNonNull java.io.InputStream pixels, long offset) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
public void writeByteBuffer(@androidx.annotation.RecentlyNonNull java.io.OutputStream dngOutput, @androidx.annotation.RecentlyNonNull android.util.Size size, @androidx.annotation.RecentlyNonNull java.nio.ByteBuffer pixels, long offset) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
public void writeImage(@androidx.annotation.RecentlyNonNull java.io.OutputStream dngOutput, @androidx.annotation.RecentlyNonNull android.media.Image pixels) throws java.io.IOException { throw new RuntimeException("Stub!"); }
