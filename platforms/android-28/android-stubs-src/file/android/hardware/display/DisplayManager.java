...
DisplayManager(android.content.Context context) { throw new RuntimeException("Stub!"); }
...
public android.hardware.display.VirtualDisplay createVirtualDisplay(@androidx.annotation.RecentlyNonNull java.lang.String name, int width, int height, int densityDpi, @androidx.annotation.RecentlyNullable android.view.Surface surface, int flags) { throw new RuntimeException("Stub!"); }
...
public android.hardware.display.VirtualDisplay createVirtualDisplay(@androidx.annotation.RecentlyNonNull java.lang.String name, int width, int height, int densityDpi, @androidx.annotation.RecentlyNullable android.view.Surface surface, int flags, @androidx.annotation.RecentlyNullable android.hardware.display.VirtualDisplay.Callback callback, @androidx.annotation.RecentlyNullable android.os.Handler handler) { throw new RuntimeException("Stub!"); }
