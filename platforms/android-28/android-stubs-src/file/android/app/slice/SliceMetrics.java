...
public SliceMetrics(@androidx.annotation.RecentlyNonNull android.content.Context context, @androidx.annotation.RecentlyNonNull android.net.Uri uri) { throw new RuntimeException("Stub!"); }
...
public void logTouch(int actionType, @androidx.annotation.RecentlyNonNull android.net.Uri subSlice) { throw new RuntimeException("Stub!"); }
}
