...
public SliceProvider(@androidx.annotation.RecentlyNonNull java.lang.String... autoGrantPermissions) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public java.util.Collection<android.net.Uri> onGetSliceDescendants(@androidx.annotation.RecentlyNonNull android.net.Uri uri) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.net.Uri onMapIntentToUri(android.content.Intent intent) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.app.PendingIntent onCreatePermissionRequest(android.net.Uri sliceUri) { throw new RuntimeException("Stub!"); }
