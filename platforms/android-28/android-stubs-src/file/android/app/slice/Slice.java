...
@androidx.annotation.RecentlyNullable public android.app.slice.SliceSpec getSpec() { throw new RuntimeException("Stub!"); }
...
public Builder(@androidx.annotation.RecentlyNonNull android.net.Uri uri, android.app.slice.SliceSpec spec) { throw new RuntimeException("Stub!"); }
...
public Builder(@androidx.annotation.RecentlyNonNull android.app.slice.Slice.Builder parent) { throw new RuntimeException("Stub!"); }
...
public android.app.slice.Slice.Builder addSubSlice(@androidx.annotation.RecentlyNonNull android.app.slice.Slice slice, @androidx.annotation.RecentlyNullable java.lang.String subType) { throw new RuntimeException("Stub!"); }
...
public android.app.slice.Slice.Builder addAction(@androidx.annotation.RecentlyNonNull android.app.PendingIntent action, @androidx.annotation.RecentlyNonNull android.app.slice.Slice s, @androidx.annotation.RecentlyNullable java.lang.String subType) { throw new RuntimeException("Stub!"); }
...
public android.app.slice.Slice.Builder addText(java.lang.CharSequence text, @androidx.annotation.RecentlyNullable java.lang.String subType, java.util.List<java.lang.String> hints) { throw new RuntimeException("Stub!"); }
...
public android.app.slice.Slice.Builder addIcon(android.graphics.drawable.Icon icon, @androidx.annotation.RecentlyNullable java.lang.String subType, java.util.List<java.lang.String> hints) { throw new RuntimeException("Stub!"); }
...
public android.app.slice.Slice.Builder addRemoteInput(android.app.RemoteInput remoteInput, @androidx.annotation.RecentlyNullable java.lang.String subType, java.util.List<java.lang.String> hints) { throw new RuntimeException("Stub!"); }
...
public android.app.slice.Slice.Builder addInt(int value, @androidx.annotation.RecentlyNullable java.lang.String subType, java.util.List<java.lang.String> hints) { throw new RuntimeException("Stub!"); }
...
public android.app.slice.Slice.Builder addLong(long value, @androidx.annotation.RecentlyNullable java.lang.String subType, java.util.List<java.lang.String> hints) { throw new RuntimeException("Stub!"); }
...
public android.app.slice.Slice.Builder addBundle(android.os.Bundle bundle, @androidx.annotation.RecentlyNullable java.lang.String subType, java.util.List<java.lang.String> hints) { throw new RuntimeException("Stub!"); }
