...
TaskStackBuilder(android.content.Context a) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.content.Intent[] getIntents() { throw new RuntimeException("Stub!"); }
}
