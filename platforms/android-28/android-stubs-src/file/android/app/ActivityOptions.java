...
@java.lang.SafeVarargs public static android.app.ActivityOptions makeSceneTransitionAnimation(android.app.Activity activity, android.util.Pair<android.view.View, java.lang.String>... sharedElements) { throw new RuntimeException("Stub!"); }
...
public android.app.ActivityOptions setLaunchBounds(@androidx.annotation.RecentlyNullable android.graphics.Rect screenSpacePixelRect) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.graphics.Rect getLaunchBounds() { throw new RuntimeException("Stub!"); }
