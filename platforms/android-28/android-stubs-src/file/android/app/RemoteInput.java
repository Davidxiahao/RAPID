...
RemoteInput(android.os.Parcel in) { throw new RuntimeException("Stub!"); }
...
public Builder(@androidx.annotation.RecentlyNonNull java.lang.String resultKey) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.app.RemoteInput.Builder setLabel(@androidx.annotation.RecentlyNullable java.lang.CharSequence label) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.app.RemoteInput.Builder setChoices(@androidx.annotation.RecentlyNullable java.lang.CharSequence[] choices) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.app.RemoteInput.Builder setAllowDataType(@androidx.annotation.RecentlyNonNull java.lang.String mimeType, boolean doAllow) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.app.RemoteInput.Builder setAllowFreeFormInput(boolean allowFreeFormTextInput) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.app.RemoteInput.Builder addExtras(@androidx.annotation.RecentlyNonNull android.os.Bundle extras) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.os.Bundle getExtras() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.app.RemoteInput build() { throw new RuntimeException("Stub!"); }
}
