...
DownloadManager(android.content.Context context) { throw new RuntimeException("Stub!"); }
...
@Deprecated public android.app.DownloadManager.Request setShowRunningNotification(boolean show) { throw new RuntimeException("Stub!"); }
