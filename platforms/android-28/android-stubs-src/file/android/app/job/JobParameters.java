...
JobParameters(android.os.Parcel in) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.net.Uri[] getTriggeredContentUris() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public java.lang.String[] getTriggeredContentAuthorities() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.net.Network getNetwork() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.app.job.JobWorkItem dequeueWork() { throw new RuntimeException("Stub!"); }
...
public void completeWork(@androidx.annotation.RecentlyNonNull android.app.job.JobWorkItem work) { throw new RuntimeException("Stub!"); }
