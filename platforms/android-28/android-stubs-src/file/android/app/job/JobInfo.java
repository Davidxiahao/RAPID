...
JobInfo(android.os.Parcel in) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.os.PersistableBundle getExtras() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.os.Bundle getTransientExtras() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.content.ClipData getClipData() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.content.ComponentName getService() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.app.job.JobInfo.TriggerContentUri[] getTriggerContentUris() { throw new RuntimeException("Stub!"); }
...
@Deprecated public int getNetworkType() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.net.NetworkRequest getRequiredNetwork() { throw new RuntimeException("Stub!"); }
...
public Builder(int jobId, @androidx.annotation.RecentlyNonNull android.content.ComponentName jobService) { throw new RuntimeException("Stub!"); }
...
public android.app.job.JobInfo.Builder setExtras(@androidx.annotation.RecentlyNonNull android.os.PersistableBundle extras) { throw new RuntimeException("Stub!"); }
...
public android.app.job.JobInfo.Builder setTransientExtras(@androidx.annotation.RecentlyNonNull android.os.Bundle extras) { throw new RuntimeException("Stub!"); }
...
public android.app.job.JobInfo.Builder setClipData(@androidx.annotation.RecentlyNullable android.content.ClipData clip, int grantFlags) { throw new RuntimeException("Stub!"); }
...
public android.app.job.JobInfo.Builder setRequiredNetwork(@androidx.annotation.RecentlyNullable android.net.NetworkRequest networkRequest) { throw new RuntimeException("Stub!"); }
...
public android.app.job.JobInfo.Builder addTriggerContentUri(@androidx.annotation.RecentlyNonNull android.app.job.JobInfo.TriggerContentUri uri) { throw new RuntimeException("Stub!"); }
...
public TriggerContentUri(@androidx.annotation.RecentlyNonNull android.net.Uri uri, int flags) { throw new RuntimeException("Stub!"); }
