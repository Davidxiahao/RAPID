...
public abstract int schedule(@androidx.annotation.RecentlyNonNull android.app.job.JobInfo job);
...
public abstract int enqueue(@androidx.annotation.RecentlyNonNull android.app.job.JobInfo job, @androidx.annotation.RecentlyNonNull android.app.job.JobWorkItem work);
...
@androidx.annotation.RecentlyNonNull public abstract java.util.List<android.app.job.JobInfo> getAllPendingJobs();
...
@androidx.annotation.RecentlyNullable public abstract android.app.job.JobInfo getPendingJob(int jobId);
