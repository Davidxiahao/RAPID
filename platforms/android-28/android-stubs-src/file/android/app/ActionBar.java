...
@Deprecated public abstract void setListNavigationCallbacks(android.widget.SpinnerAdapter adapter, android.app.ActionBar.OnNavigationListener callback);
...
public abstract void setBackgroundDrawable(@androidx.annotation.RecentlyNullable android.graphics.drawable.Drawable d);
...
@Deprecated public abstract void setNavigationMode(int mode);
...
@Deprecated public abstract android.app.ActionBar.Tab newTab();
...
@Deprecated public abstract void addTab(android.app.ActionBar.Tab tab);
...
@Deprecated public abstract void addTab(android.app.ActionBar.Tab tab, boolean setSelected);
...
@Deprecated public abstract void addTab(android.app.ActionBar.Tab tab, int position);
...
@Deprecated public abstract void addTab(android.app.ActionBar.Tab tab, int position, boolean setSelected);
...
@Deprecated public abstract void removeTab(android.app.ActionBar.Tab tab);
...
@Deprecated public abstract void selectTab(android.app.ActionBar.Tab tab);
...
@Deprecated public abstract android.app.ActionBar.Tab getSelectedTab();
...
@Deprecated public abstract android.app.ActionBar.Tab getTabAt(int index);
...
public LayoutParams(@androidx.annotation.RecentlyNonNull android.content.Context c, android.util.AttributeSet attrs) { super((android.view.ViewGroup.MarginLayoutParams)null); throw new RuntimeException("Stub!"); }
...
@SuppressWarnings({"unchecked", "deprecation", "all"})
@Deprecated public static interface OnNavigationListener {
...
@SuppressWarnings({"unchecked", "deprecation", "all"})
@Deprecated public abstract static class Tab {
...
@SuppressWarnings({"unchecked", "deprecation", "all"})
@Deprecated public static interface TabListener {
