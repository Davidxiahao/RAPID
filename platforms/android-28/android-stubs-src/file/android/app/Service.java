...
@Deprecated public void onStart(android.content.Intent intent, int startId) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public abstract android.os.IBinder onBind(android.content.Intent intent);
