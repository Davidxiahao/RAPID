...
@Deprecated public int getParseMaxDigits() { throw new RuntimeException("Stub!"); }
...
@Deprecated public void setParseMaxDigits(int maxDigits) { throw new RuntimeException("Stub!"); }
