...
@Deprecated protected int computeMillisInDay() { throw new RuntimeException("Stub!"); }
...
@Deprecated protected int computeZoneOffset(long millis, int millisInDay) { throw new RuntimeException("Stub!"); }
