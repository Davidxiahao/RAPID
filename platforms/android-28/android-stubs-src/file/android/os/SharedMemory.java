...
SharedMemory(java.io.FileDescriptor fd) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.os.SharedMemory create(@androidx.annotation.RecentlyNullable java.lang.String name, int size) throws android.system.ErrnoException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public java.nio.ByteBuffer mapReadWrite() throws android.system.ErrnoException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public java.nio.ByteBuffer mapReadOnly() throws android.system.ErrnoException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public java.nio.ByteBuffer map(int prot, int offset, int length) throws android.system.ErrnoException { throw new RuntimeException("Stub!"); }
...
public static void unmap(@androidx.annotation.RecentlyNonNull java.nio.ByteBuffer buffer) { throw new RuntimeException("Stub!"); }
