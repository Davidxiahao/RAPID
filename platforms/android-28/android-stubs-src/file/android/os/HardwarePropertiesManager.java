...
@androidx.annotation.RecentlyNonNull public float[] getDeviceTemperatures(int type, int source) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.os.CpuUsageInfo[] getCpuUsages() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public float[] getFanSpeeds() { throw new RuntimeException("Stub!"); }
