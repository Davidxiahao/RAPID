...
@Deprecated public ResourceCursorAdapter(android.content.Context context, int layout, android.database.Cursor c) { super((android.content.Context)null, (android.database.Cursor)null); throw new RuntimeException("Stub!"); }
