...
public void setEnterTransition(@androidx.annotation.RecentlyNullable android.transition.Transition enterTransition) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.transition.Transition getEnterTransition() { throw new RuntimeException("Stub!"); }
...
public void setExitTransition(@androidx.annotation.RecentlyNullable android.transition.Transition exitTransition) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.transition.Transition getExitTransition() { throw new RuntimeException("Stub!"); }
...
@Deprecated public void setWindowLayoutMode(int widthSpec, int heightSpec) { throw new RuntimeException("Stub!"); }
...
public int getMaxAvailableHeight(@androidx.annotation.RecentlyNonNull android.view.View anchor) { throw new RuntimeException("Stub!"); }
...
public int getMaxAvailableHeight(@androidx.annotation.RecentlyNonNull android.view.View anchor, int yOffset) { throw new RuntimeException("Stub!"); }
...
public int getMaxAvailableHeight(@androidx.annotation.RecentlyNonNull android.view.View anchor, int yOffset, boolean ignoreBottomDecorations) { throw new RuntimeException("Stub!"); }
