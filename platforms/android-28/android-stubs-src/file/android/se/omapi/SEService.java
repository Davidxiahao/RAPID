...
public SEService(@androidx.annotation.RecentlyNonNull android.content.Context context, @androidx.annotation.RecentlyNonNull java.util.concurrent.Executor executor, @androidx.annotation.RecentlyNonNull android.se.omapi.SEService.OnConnectedListener listener) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.se.omapi.Reader[] getReaders() { throw new RuntimeException("Stub!"); }
