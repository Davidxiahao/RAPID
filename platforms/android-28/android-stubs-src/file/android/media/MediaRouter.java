...
MediaRouter(android.content.Context context) { throw new RuntimeException("Stub!"); }
...
public void selectRoute(int types, @androidx.annotation.RecentlyNonNull android.media.MediaRouter.RouteInfo route) { throw new RuntimeException("Stub!"); }
...
RouteCategory(java.lang.CharSequence name, int types, boolean groupable) { throw new RuntimeException("Stub!"); }
...
RouteGroup(android.media.MediaRouter.RouteCategory category) { super(null); throw new RuntimeException("Stub!"); }
...
RouteInfo(android.media.MediaRouter.RouteCategory category) { throw new RuntimeException("Stub!"); }
...
UserRouteInfo(android.media.MediaRouter.RouteCategory category) { super(null); throw new RuntimeException("Stub!"); }
