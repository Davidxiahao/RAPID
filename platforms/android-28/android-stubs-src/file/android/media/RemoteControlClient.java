...
public static final int FLAG_KEY_MEDIA_FAST_FORWARD = 64; // 0x40
...
public static final int FLAG_KEY_MEDIA_NEXT = 128; // 0x80
...
public static final int FLAG_KEY_MEDIA_PAUSE = 16; // 0x10
...
public static final int FLAG_KEY_MEDIA_PLAY = 4; // 0x4
...
public static final int FLAG_KEY_MEDIA_PLAY_PAUSE = 8; // 0x8
...
public static final int FLAG_KEY_MEDIA_POSITION_UPDATE = 256; // 0x100
...
public static final int FLAG_KEY_MEDIA_PREVIOUS = 1; // 0x1
...
public static final int FLAG_KEY_MEDIA_RATING = 512; // 0x200
...
public static final int FLAG_KEY_MEDIA_REWIND = 2; // 0x2
...
public static final int FLAG_KEY_MEDIA_STOP = 32; // 0x20
...
public static final int PLAYSTATE_BUFFERING = 8; // 0x8
...
public static final int PLAYSTATE_ERROR = 9; // 0x9
...
public static final int PLAYSTATE_FAST_FORWARDING = 4; // 0x4
...
public static final int PLAYSTATE_REWINDING = 5; // 0x5
...
public static final int PLAYSTATE_SKIPPING_BACKWARDS = 7; // 0x7
...
public static final int PLAYSTATE_SKIPPING_FORWARDS = 6; // 0x6
...
@SuppressWarnings({"unchecked", "deprecation", "all"})
@Deprecated public class MetadataEditor extends android.media.MediaMetadataEditor {
