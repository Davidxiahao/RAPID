...
public DynamicsProcessing(int audioSession) { super(null, null, 0, 0); throw new RuntimeException("Stub!"); }
...
public DynamicsProcessing(int priority, int audioSession, @androidx.annotation.RecentlyNullable android.media.audiofx.DynamicsProcessing.Config cfg) { super(null, null, 0, 0); throw new RuntimeException("Stub!"); }
...
Config(@androidx.annotation.RecentlyNonNull android.media.audiofx.DynamicsProcessing.Config cfg) { throw new RuntimeException("Stub!"); }
