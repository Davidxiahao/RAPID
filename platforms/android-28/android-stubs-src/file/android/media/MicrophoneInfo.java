...
MicrophoneInfo(java.lang.String deviceId, int type, java.lang.String address, int location, int group, int indexInTheGroup, android.media.MicrophoneInfo.Coordinate3F position, android.media.MicrophoneInfo.Coordinate3F orientation, java.util.List<android.util.Pair<java.lang.Float, java.lang.Float>> frequencyResponse, java.util.List<android.util.Pair<java.lang.Integer, java.lang.Integer>> channelMapping, float sensitivity, float maxSpl, float minSpl, int directionality) { throw new RuntimeException("Stub!"); }
...
Coordinate3F(float x, float y, float z) { throw new RuntimeException("Stub!"); }
