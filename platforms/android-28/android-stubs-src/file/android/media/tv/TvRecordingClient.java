...
public TvRecordingClient(android.content.Context context, java.lang.String tag, @androidx.annotation.RecentlyNonNull android.media.tv.TvRecordingClient.RecordingCallback callback, android.os.Handler handler) { throw new RuntimeException("Stub!"); }
...
public void startRecording(@androidx.annotation.RecentlyNullable android.net.Uri programUri) { throw new RuntimeException("Stub!"); }
