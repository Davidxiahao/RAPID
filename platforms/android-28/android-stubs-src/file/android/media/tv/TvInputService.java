...
@androidx.annotation.RecentlyNullable public abstract android.media.tv.TvInputService.Session onCreateSession(java.lang.String inputId);
...
@androidx.annotation.RecentlyNullable public android.media.tv.TvInputService.RecordingSession onCreateRecordingSession(java.lang.String inputId) { throw new RuntimeException("Stub!"); }
...
public abstract void onStartRecording(@androidx.annotation.RecentlyNullable android.net.Uri programUri);
...
public void onAppPrivateCommand(@androidx.annotation.RecentlyNonNull java.lang.String action, android.os.Bundle data) { throw new RuntimeException("Stub!"); }
}
...
public void notifyContentBlocked(@androidx.annotation.RecentlyNonNull android.media.tv.TvContentRating rating) { throw new RuntimeException("Stub!"); }
...
public abstract boolean onSetSurface(@androidx.annotation.RecentlyNullable android.view.Surface surface);
...
public boolean onSelectTrack(int type, @androidx.annotation.RecentlyNullable java.lang.String trackId) { throw new RuntimeException("Stub!"); }
