...
MediaCodec(java.lang.String name, boolean nameIsType, boolean encoder) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.media.MediaCodec createDecoderByType(@androidx.annotation.RecentlyNonNull java.lang.String type) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.media.MediaCodec createEncoderByType(@androidx.annotation.RecentlyNonNull java.lang.String type) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.media.MediaCodec createByCodecName(@androidx.annotation.RecentlyNonNull java.lang.String name) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
public void configure(@androidx.annotation.RecentlyNullable android.media.MediaFormat format, @androidx.annotation.RecentlyNullable android.view.Surface surface, @androidx.annotation.RecentlyNullable android.media.MediaCrypto crypto, int flags) { throw new RuntimeException("Stub!"); }
...
public void configure(@androidx.annotation.RecentlyNullable android.media.MediaFormat format, @androidx.annotation.RecentlyNullable android.view.Surface surface, int flags, @androidx.annotation.RecentlyNullable android.media.MediaDescrambler descrambler) { throw new RuntimeException("Stub!"); }
...
public void setOutputSurface(@androidx.annotation.RecentlyNonNull android.view.Surface surface) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.view.Surface createPersistentInputSurface() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public native android.view.Surface createInputSurface();
...
public void queueSecureInputBuffer(int index, int offset, @androidx.annotation.RecentlyNonNull android.media.MediaCodec.CryptoInfo info, long presentationTimeUs, int flags) throws android.media.MediaCodec.CryptoException { throw new RuntimeException("Stub!"); }
...
public int dequeueOutputBuffer(@androidx.annotation.RecentlyNonNull android.media.MediaCodec.BufferInfo info, long timeoutUs) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.media.MediaFormat getOutputFormat() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.media.MediaFormat getInputFormat() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.media.MediaFormat getOutputFormat(int index) { throw new RuntimeException("Stub!"); }
...
@Deprecated @androidx.annotation.RecentlyNonNull public java.nio.ByteBuffer[] getInputBuffers() { throw new RuntimeException("Stub!"); }
...
@Deprecated @androidx.annotation.RecentlyNonNull public java.nio.ByteBuffer[] getOutputBuffers() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public java.nio.ByteBuffer getInputBuffer(int index) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.media.Image getInputImage(int index) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public java.nio.ByteBuffer getOutputBuffer(int index) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.media.Image getOutputImage(int index) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public native java.lang.String getName();
...
public void setParameters(@androidx.annotation.RecentlyNullable android.os.Bundle params) { throw new RuntimeException("Stub!"); }
...
public void setCallback(@androidx.annotation.RecentlyNullable android.media.MediaCodec.Callback cb, @androidx.annotation.RecentlyNullable android.os.Handler handler) { throw new RuntimeException("Stub!"); }
...
public void setCallback(@androidx.annotation.RecentlyNullable android.media.MediaCodec.Callback cb) { throw new RuntimeException("Stub!"); }
...
public void setOnFrameRenderedListener(@androidx.annotation.RecentlyNullable android.media.MediaCodec.OnFrameRenderedListener listener, @androidx.annotation.RecentlyNullable android.os.Handler handler) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.media.MediaCodecInfo getCodecInfo() { throw new RuntimeException("Stub!"); }
...
public abstract void onInputBufferAvailable(@androidx.annotation.RecentlyNonNull android.media.MediaCodec codec, int index);
...
public abstract void onOutputBufferAvailable(@androidx.annotation.RecentlyNonNull android.media.MediaCodec codec, int index, @androidx.annotation.RecentlyNonNull android.media.MediaCodec.BufferInfo info);
...
public abstract void onError(@androidx.annotation.RecentlyNonNull android.media.MediaCodec codec, @androidx.annotation.RecentlyNonNull android.media.MediaCodec.CodecException e);
...
public abstract void onOutputFormatChanged(@androidx.annotation.RecentlyNonNull android.media.MediaCodec codec, @androidx.annotation.RecentlyNonNull android.media.MediaFormat format);
}
...
CodecException(int errorCode, int actionCode, java.lang.String detailMessage) { throw new RuntimeException("Stub!"); }
...
public void set(int newNumSubSamples, @androidx.annotation.RecentlyNonNull int[] newNumBytesOfClearData, @androidx.annotation.RecentlyNonNull int[] newNumBytesOfEncryptedData, @androidx.annotation.RecentlyNonNull byte[] newKey, @androidx.annotation.RecentlyNonNull byte[] newIV, int newMode) { throw new RuntimeException("Stub!"); }
...
public void onFrameRendered(@androidx.annotation.RecentlyNonNull android.media.MediaCodec codec, long presentationTimeUs, long nanoTime);
}
