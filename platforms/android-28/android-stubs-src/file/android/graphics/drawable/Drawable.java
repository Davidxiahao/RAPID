...
public abstract void draw(@androidx.annotation.RecentlyNonNull android.graphics.Canvas canvas);
...
public void setBounds(@androidx.annotation.RecentlyNonNull android.graphics.Rect bounds) { throw new RuntimeException("Stub!"); }
...
public final void copyBounds(@androidx.annotation.RecentlyNonNull android.graphics.Rect bounds) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public final android.graphics.Rect copyBounds() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public final android.graphics.Rect getBounds() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.graphics.Rect getDirtyBounds() { throw new RuntimeException("Stub!"); }
...
@Deprecated public void setDither(boolean dither) { throw new RuntimeException("Stub!"); }
...
public final void setCallback(@androidx.annotation.RecentlyNullable android.graphics.drawable.Drawable.Callback cb) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.graphics.drawable.Drawable.Callback getCallback() { throw new RuntimeException("Stub!"); }
...
public void scheduleSelf(@androidx.annotation.RecentlyNonNull java.lang.Runnable what, long when) { throw new RuntimeException("Stub!"); }
...
public void unscheduleSelf(@androidx.annotation.RecentlyNonNull java.lang.Runnable what) { throw new RuntimeException("Stub!"); }
...
public abstract void setColorFilter(@androidx.annotation.RecentlyNullable android.graphics.ColorFilter colorFilter);
...
public void setColorFilter(int color, @androidx.annotation.RecentlyNonNull android.graphics.PorterDuff.Mode mode) { throw new RuntimeException("Stub!"); }
...
public void setTintMode(@androidx.annotation.RecentlyNonNull android.graphics.PorterDuff.Mode tintMode) { throw new RuntimeException("Stub!"); }
...
public boolean setState(@androidx.annotation.RecentlyNonNull int[] stateSet) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public int[] getState() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.graphics.drawable.Drawable getCurrent() { throw new RuntimeException("Stub!"); }
...
@Deprecated @androidx.annotation.RecentlyNullable public static android.graphics.drawable.Drawable createFromResourceStream(@androidx.annotation.RecentlyNullable android.content.res.Resources res, @androidx.annotation.RecentlyNullable android.util.TypedValue value, @androidx.annotation.RecentlyNullable java.io.InputStream is, @androidx.annotation.RecentlyNullable java.lang.String srcName, @androidx.annotation.RecentlyNullable android.graphics.BitmapFactory.Options opts) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.graphics.drawable.Drawable createFromXml(@androidx.annotation.RecentlyNonNull android.content.res.Resources r, @androidx.annotation.RecentlyNonNull org.xmlpull.v1.XmlPullParser parser) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.graphics.drawable.Drawable createFromXml(@androidx.annotation.RecentlyNonNull android.content.res.Resources r, @androidx.annotation.RecentlyNonNull org.xmlpull.v1.XmlPullParser parser, @androidx.annotation.RecentlyNullable android.content.res.Resources.Theme theme) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.graphics.drawable.Drawable createFromXmlInner(@androidx.annotation.RecentlyNonNull android.content.res.Resources r, @androidx.annotation.RecentlyNonNull org.xmlpull.v1.XmlPullParser parser, @androidx.annotation.RecentlyNonNull android.util.AttributeSet attrs) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.graphics.drawable.Drawable createFromXmlInner(@androidx.annotation.RecentlyNonNull android.content.res.Resources r, @androidx.annotation.RecentlyNonNull org.xmlpull.v1.XmlPullParser parser, @androidx.annotation.RecentlyNonNull android.util.AttributeSet attrs, @androidx.annotation.RecentlyNullable android.content.res.Resources.Theme theme) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public static android.graphics.drawable.Drawable createFromPath(java.lang.String pathName) { throw new RuntimeException("Stub!"); }
...
public void inflate(@androidx.annotation.RecentlyNonNull android.content.res.Resources r, @androidx.annotation.RecentlyNonNull org.xmlpull.v1.XmlPullParser parser, @androidx.annotation.RecentlyNonNull android.util.AttributeSet attrs) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException { throw new RuntimeException("Stub!"); }
...
public void invalidateDrawable(@androidx.annotation.RecentlyNonNull android.graphics.drawable.Drawable who);
...
public void scheduleDrawable(@androidx.annotation.RecentlyNonNull android.graphics.drawable.Drawable who, @androidx.annotation.RecentlyNonNull java.lang.Runnable what, long when);
...
public void unscheduleDrawable(@androidx.annotation.RecentlyNonNull android.graphics.drawable.Drawable who, @androidx.annotation.RecentlyNonNull java.lang.Runnable what);
}
...
@androidx.annotation.RecentlyNonNull public abstract android.graphics.drawable.Drawable newDrawable();
...
@androidx.annotation.RecentlyNonNull public android.graphics.drawable.Drawable newDrawable(@androidx.annotation.RecentlyNullable android.content.res.Resources res) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.graphics.drawable.Drawable newDrawable(@androidx.annotation.RecentlyNullable android.content.res.Resources res, @androidx.annotation.RecentlyNullable android.content.res.Resources.Theme theme) { throw new RuntimeException("Stub!"); }
