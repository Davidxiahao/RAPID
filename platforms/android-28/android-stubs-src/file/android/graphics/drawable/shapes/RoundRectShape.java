...
public RoundRectShape(@androidx.annotation.RecentlyNullable float[] outerRadii, @androidx.annotation.RecentlyNullable android.graphics.RectF inset, @androidx.annotation.RecentlyNullable float[] innerRadii) { throw new RuntimeException("Stub!"); }
