...
public PdfRenderer(@androidx.annotation.RecentlyNonNull android.os.ParcelFileDescriptor input) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
Page(int index) { throw new RuntimeException("Stub!"); }
...
public void render(@androidx.annotation.RecentlyNonNull android.graphics.Bitmap destination, @androidx.annotation.RecentlyNullable android.graphics.Rect destClip, @androidx.annotation.RecentlyNullable android.graphics.Matrix transform, int renderMode) { throw new RuntimeException("Stub!"); }
