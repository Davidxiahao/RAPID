...
public void setOnFrameAvailableListener(@androidx.annotation.RecentlyNullable android.graphics.SurfaceTexture.OnFrameAvailableListener listener) { throw new RuntimeException("Stub!"); }
...
public void setOnFrameAvailableListener(@androidx.annotation.RecentlyNullable android.graphics.SurfaceTexture.OnFrameAvailableListener listener, @androidx.annotation.RecentlyNullable android.os.Handler handler) { throw new RuntimeException("Stub!"); }
...
@SuppressWarnings({"unchecked", "deprecation", "all"})
@Deprecated public static class OutOfResourcesException extends java.lang.Exception {
