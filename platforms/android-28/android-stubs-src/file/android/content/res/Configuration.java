...
public int updateFrom(@androidx.annotation.RecentlyNonNull android.content.res.Configuration delta) { throw new RuntimeException("Stub!"); }
...
public void setLocales(@androidx.annotation.RecentlyNullable android.os.LocaleList locales) { throw new RuntimeException("Stub!"); }
...
public void setLocale(@androidx.annotation.RecentlyNullable java.util.Locale loc) { throw new RuntimeException("Stub!"); }
