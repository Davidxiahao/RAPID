...
@androidx.annotation.RecentlyNonNull public static android.content.res.ColorStateList valueOf(int color) { throw new RuntimeException("Stub!"); }
...
@Deprecated @androidx.annotation.RecentlyNonNull public static android.content.res.ColorStateList createFromXml(android.content.res.Resources r, org.xmlpull.v1.XmlPullParser parser) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.content.res.ColorStateList createFromXml(@androidx.annotation.RecentlyNonNull android.content.res.Resources r, @androidx.annotation.RecentlyNonNull org.xmlpull.v1.XmlPullParser parser, @androidx.annotation.RecentlyNullable android.content.res.Resources.Theme theme) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.content.res.ColorStateList withAlpha(int alpha) { throw new RuntimeException("Stub!"); }
...
public int getColorForState(@androidx.annotation.RecentlyNullable int[] stateSet, int defaultColor) { throw new RuntimeException("Stub!"); }
