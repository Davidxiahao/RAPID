...
ShortcutManager(android.content.Context context) { throw new RuntimeException("Stub!"); }
...
public boolean setDynamicShortcuts(@androidx.annotation.RecentlyNonNull java.util.List<android.content.pm.ShortcutInfo> shortcutInfoList) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public java.util.List<android.content.pm.ShortcutInfo> getDynamicShortcuts() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public java.util.List<android.content.pm.ShortcutInfo> getManifestShortcuts() { throw new RuntimeException("Stub!"); }
...
public boolean addDynamicShortcuts(@androidx.annotation.RecentlyNonNull java.util.List<android.content.pm.ShortcutInfo> shortcutInfoList) { throw new RuntimeException("Stub!"); }
...
public void removeDynamicShortcuts(@androidx.annotation.RecentlyNonNull java.util.List<java.lang.String> shortcutIds) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public java.util.List<android.content.pm.ShortcutInfo> getPinnedShortcuts() { throw new RuntimeException("Stub!"); }
...
public boolean updateShortcuts(@androidx.annotation.RecentlyNonNull java.util.List<android.content.pm.ShortcutInfo> shortcutInfoList) { throw new RuntimeException("Stub!"); }
...
public void disableShortcuts(@androidx.annotation.RecentlyNonNull java.util.List<java.lang.String> shortcutIds) { throw new RuntimeException("Stub!"); }
...
public void disableShortcuts(@androidx.annotation.RecentlyNonNull java.util.List<java.lang.String> shortcutIds, java.lang.CharSequence disabledMessage) { throw new RuntimeException("Stub!"); }
...
public void enableShortcuts(@androidx.annotation.RecentlyNonNull java.util.List<java.lang.String> shortcutIds) { throw new RuntimeException("Stub!"); }
...
public boolean requestPinShortcut(@androidx.annotation.RecentlyNonNull android.content.pm.ShortcutInfo shortcut, @androidx.annotation.RecentlyNullable android.content.IntentSender resultIntent) { throw new RuntimeException("Stub!"); }
...
public android.content.Intent createShortcutResultIntent(@androidx.annotation.RecentlyNonNull android.content.pm.ShortcutInfo shortcut) { throw new RuntimeException("Stub!"); }
}
