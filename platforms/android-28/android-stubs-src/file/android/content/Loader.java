...
@SuppressWarnings({"unchecked", "deprecation", "all"})
@Deprecated public final class ForceLoadContentObserver extends android.database.ContentObserver {
...
@SuppressWarnings({"unchecked", "deprecation", "all"})
@Deprecated public static interface OnLoadCanceledListener<D> {
...
@SuppressWarnings({"unchecked", "deprecation", "all"})
@Deprecated public static interface OnLoadCompleteListener<D> {
