...
public <T> T[] getSpans(int queryStart, int queryEnd, @androidx.annotation.RecentlyNullable java.lang.Class<T> kind) { throw new RuntimeException("Stub!"); }
...
@Deprecated public int getTextRunCursor(int contextStart, int contextEnd, int dir, int offset, int cursorOpt, android.graphics.Paint p) { throw new RuntimeException("Stub!"); }
