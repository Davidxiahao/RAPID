...
BidiFormatter(boolean isRtlContext, int flags, android.text.TextDirectionHeuristic heuristic) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public java.lang.String unicodeWrap(@androidx.annotation.RecentlyNullable java.lang.String str, android.text.TextDirectionHeuristic heuristic, boolean isolate) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public java.lang.CharSequence unicodeWrap(@androidx.annotation.RecentlyNullable java.lang.CharSequence str, android.text.TextDirectionHeuristic heuristic, boolean isolate) { throw new RuntimeException("Stub!"); }
