...
@Deprecated public TimeKeyListener() { throw new RuntimeException("Stub!"); }

/**
 * @param locale This value may be {@code null}.
 */

public TimeKeyListener(@androidx.annotation.RecentlyNullable java.util.Locale locale) { throw new RuntimeException("Stub!"); }
...
@Deprecated @androidx.annotation.RecentlyNonNull public static android.text.method.TimeKeyListener getInstance() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public static android.text.method.TimeKeyListener getInstance(@androidx.annotation.RecentlyNullable java.util.Locale locale) { throw new RuntimeException("Stub!"); }
