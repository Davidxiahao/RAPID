...
public static final int EPOCH_JULIAN_DAY = 2440588; // 0x253d8c

public static final int FRIDAY = 5; // 0x5

public static final int HOUR = 3; // 0x3

public static final int MINUTE = 2; // 0x2

public static final int MONDAY = 1; // 0x1
...
public static final int MONDAY_BEFORE_JULIAN_EPOCH = 2440585; // 0x253d89

public static final int MONTH = 5; // 0x5

public static final int MONTH_DAY = 4; // 0x4

public static final int SATURDAY = 6; // 0x6

public static final int SECOND = 1; // 0x1

public static final int SUNDAY = 0; // 0x0

public static final int THURSDAY = 4; // 0x4

public static final java.lang.String TIMEZONE_UTC = "UTC";

public static final int TUESDAY = 2; // 0x2

public static final int WEDNESDAY = 3; // 0x3

public static final int WEEK_DAY = 7; // 0x7

public static final int WEEK_NUM = 9; // 0x9

public static final int YEAR = 6; // 0x6

public static final int YEAR_DAY = 8; // 0x8
