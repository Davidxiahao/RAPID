...
BluetoothHealth(android.content.Context context, android.bluetooth.BluetoothProfile.ServiceListener l) { throw new RuntimeException("Stub!"); }
...
public static final int APP_CONFIG_REGISTRATION_FAILURE = 1; // 0x1

/** Health App Configuration registration success */

public static final int APP_CONFIG_REGISTRATION_SUCCESS = 0; // 0x0

/** Health App Configuration un-registration failure */

public static final int APP_CONFIG_UNREGISTRATION_FAILURE = 3; // 0x3

/** Health App Configuration un-registration success */

public static final int APP_CONFIG_UNREGISTRATION_SUCCESS = 2; // 0x2

/**
 * Health Profile - Channel Type used - Reliable
 */

public static final int CHANNEL_TYPE_RELIABLE = 10; // 0xa

/**
 * Health Profile - Channel Type used - Streaming
 */

public static final int CHANNEL_TYPE_STREAMING = 11; // 0xb

/**
 * Health Profile Sink Role the device talking to the health device.
 */

public static final int SINK_ROLE = 2; // 0x2

/**
 * Health Profile Source Role - the health device.
 */

public static final int SOURCE_ROLE = 1; // 0x1

/** Health Channel Connection State - Connected */

public static final int STATE_CHANNEL_CONNECTED = 2; // 0x2

/** Health Channel Connection State - Connecting */

public static final int STATE_CHANNEL_CONNECTING = 1; // 0x1

/** Health Channel Connection State - Disconnected */

public static final int STATE_CHANNEL_DISCONNECTED = 0; // 0x0

/** Health Channel Connection State - Disconnecting */

public static final int STATE_CHANNEL_DISCONNECTING = 3; // 0x3
}
