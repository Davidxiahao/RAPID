...
GnssMeasurementsEvent(android.location.GnssClock clock, android.location.GnssMeasurement[] measurements) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.location.GnssClock getClock() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public java.util.Collection<android.location.GnssMeasurement> getMeasurements() { throw new RuntimeException("Stub!"); }
