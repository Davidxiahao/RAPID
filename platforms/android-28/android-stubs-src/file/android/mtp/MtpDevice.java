...
public MtpDevice(@androidx.annotation.RecentlyNonNull android.hardware.usb.UsbDevice device) { throw new RuntimeException("Stub!"); }
...
public boolean open(@androidx.annotation.RecentlyNonNull android.hardware.usb.UsbDeviceConnection connection) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.mtp.MtpDeviceInfo getDeviceInfo() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public int[] getStorageIds() { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public int[] getObjectHandles(int storageId, int format, int objectHandle) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public byte[] getObject(int objectHandle, int objectSize) { throw new RuntimeException("Stub!"); }
...
public long getPartialObject(int objectHandle, long offset, long size, @androidx.annotation.RecentlyNonNull byte[] buffer) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
public long getPartialObject64(int objectHandle, long offset, long size, @androidx.annotation.RecentlyNonNull byte[] buffer) throws java.io.IOException { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public byte[] getThumbnail(int objectHandle) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.mtp.MtpStorageInfo getStorageInfo(int storageId) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.mtp.MtpObjectInfo getObjectInfo(int objectHandle) { throw new RuntimeException("Stub!"); }
...
public boolean importFile(int objectHandle, @androidx.annotation.RecentlyNonNull java.lang.String destPath) { throw new RuntimeException("Stub!"); }
...
public boolean importFile(int objectHandle, @androidx.annotation.RecentlyNonNull android.os.ParcelFileDescriptor descriptor) { throw new RuntimeException("Stub!"); }
...
public boolean sendObject(int objectHandle, long size, @androidx.annotation.RecentlyNonNull android.os.ParcelFileDescriptor descriptor) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public android.mtp.MtpObjectInfo sendObjectInfo(@androidx.annotation.RecentlyNonNull android.mtp.MtpObjectInfo info) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.mtp.MtpEvent readEvent(@androidx.annotation.RecentlyNullable android.os.CancellationSignal signal) throws java.io.IOException { throw new RuntimeException("Stub!"); }
}
