...
@androidx.annotation.RecentlyNonNull public android.net.IpSecTransform.Builder setEncryption(@androidx.annotation.RecentlyNonNull android.net.IpSecAlgorithm algo) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.net.IpSecTransform.Builder setAuthentication(@androidx.annotation.RecentlyNonNull android.net.IpSecAlgorithm algo) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.net.IpSecTransform.Builder setAuthenticatedEncryption(@androidx.annotation.RecentlyNonNull android.net.IpSecAlgorithm algo) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.net.IpSecTransform.Builder setIpv4Encapsulation(@androidx.annotation.RecentlyNonNull android.net.IpSecManager.UdpEncapsulationSocket localSocket, int remotePort) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNonNull public android.net.IpSecTransform buildTransportModeTransform(@androidx.annotation.RecentlyNonNull java.net.InetAddress sourceAddress, @androidx.annotation.RecentlyNonNull android.net.IpSecManager.SecurityParameterIndex spi) throws java.io.IOException, android.net.IpSecManager.ResourceUnavailableException, android.net.IpSecManager.SpiUnavailableException { throw new RuntimeException("Stub!"); }
}
