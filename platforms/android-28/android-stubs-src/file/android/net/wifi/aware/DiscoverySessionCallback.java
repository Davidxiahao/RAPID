...
public void onPublishStarted(@androidx.annotation.RecentlyNonNull android.net.wifi.aware.PublishDiscoverySession session) { throw new RuntimeException("Stub!"); }
...
public void onSubscribeStarted(@androidx.annotation.RecentlyNonNull android.net.wifi.aware.SubscribeDiscoverySession session) { throw new RuntimeException("Stub!"); }
