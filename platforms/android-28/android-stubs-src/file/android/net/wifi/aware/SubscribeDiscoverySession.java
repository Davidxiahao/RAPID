...
SubscribeDiscoverySession(android.net.wifi.aware.WifiAwareManager manager, int clientId, int sessionId) { super(null, 0, 0); throw new RuntimeException("Stub!"); }
...
public void updateSubscribe(@androidx.annotation.RecentlyNonNull android.net.wifi.aware.SubscribeConfig subscribeConfig) { throw new RuntimeException("Stub!"); }
}
