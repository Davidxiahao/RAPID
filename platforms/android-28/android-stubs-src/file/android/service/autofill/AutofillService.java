...
public abstract void onFillRequest(@androidx.annotation.RecentlyNonNull android.service.autofill.FillRequest request, @androidx.annotation.RecentlyNonNull android.os.CancellationSignal cancellationSignal, @androidx.annotation.RecentlyNonNull android.service.autofill.FillCallback callback);
...
public abstract void onSaveRequest(@androidx.annotation.RecentlyNonNull android.service.autofill.SaveRequest request, @androidx.annotation.RecentlyNonNull android.service.autofill.SaveCallback callback);
...
@androidx.annotation.RecentlyNullable public final android.service.autofill.FillEventHistory getFillEventHistory() { throw new RuntimeException("Stub!"); }
