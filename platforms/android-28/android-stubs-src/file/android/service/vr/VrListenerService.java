...
public static final boolean isVrModePackageEnabled(@androidx.annotation.RecentlyNonNull android.content.Context context, @androidx.annotation.RecentlyNonNull android.content.ComponentName requestedComponent) { throw new RuntimeException("Stub!"); }
