...
Allocation(long id, android.renderscript.RenderScript rs, android.renderscript.Type t, int usage) { super(0, null); throw new RuntimeException("Stub!"); }
...
@Deprecated public synchronized void resize(int dimX) { throw new RuntimeException("Stub!"); }
