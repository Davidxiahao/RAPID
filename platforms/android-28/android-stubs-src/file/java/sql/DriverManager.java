...
@Deprecated public static void setLogStream(java.io.PrintStream out) { throw new RuntimeException("Stub!"); }
...
@Deprecated public static java.io.PrintStream getLogStream() { throw new RuntimeException("Stub!"); }
