...
@Deprecated public Time(int hour, int minute, int second) { throw new RuntimeException("Stub!"); }
...
@Deprecated public void setYear(int i) { throw new RuntimeException("Stub!"); }
...
@Deprecated public void setMonth(int i) { throw new RuntimeException("Stub!"); }
...
@Deprecated public void setDate(int i) { throw new RuntimeException("Stub!"); }
}
