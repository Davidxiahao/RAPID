...
public SoftReference(T referent) { super(null); throw new RuntimeException("Stub!"); }
...
public SoftReference(T referent, java.lang.ref.ReferenceQueue<? super T> q) { super(null); throw new RuntimeException("Stub!"); }
