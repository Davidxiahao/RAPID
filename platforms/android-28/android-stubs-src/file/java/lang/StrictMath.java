...
public static strictfp double toRadians(double angdeg) { throw new RuntimeException("Stub!"); }
...
public static strictfp double toDegrees(double angrad) { throw new RuntimeException("Stub!"); }
