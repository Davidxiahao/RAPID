...
@Deprecated public boolean getInCheck() { throw new RuntimeException("Stub!"); }
...
@Deprecated protected java.lang.ClassLoader currentClassLoader() { throw new RuntimeException("Stub!"); }

/**
 * @deprecated Use {@link #checkPermission} instead.
 */

@Deprecated protected java.lang.Class<?> currentLoadedClass() { throw new RuntimeException("Stub!"); }

/**
 * @deprecated Use {@link #checkPermission} instead.
 */

@Deprecated protected int classDepth(java.lang.String name) { throw new RuntimeException("Stub!"); }

/**
 * @deprecated Use {@link #checkPermission} instead.
 */

@Deprecated protected int classLoaderDepth() { throw new RuntimeException("Stub!"); }

/**
 * @deprecated Use {@link #checkPermission} instead.
 */

@Deprecated protected boolean inClass(java.lang.String name) { throw new RuntimeException("Stub!"); }

/**
 * @deprecated Use {@link #checkPermission} instead.
 */

@Deprecated protected boolean inClassLoader() { throw new RuntimeException("Stub!"); }
...
@Deprecated public void checkMulticast(java.net.InetAddress maddr, byte ttl) { throw new RuntimeException("Stub!"); }
