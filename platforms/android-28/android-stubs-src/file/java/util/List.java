...
@androidx.annotation.RecentlyNonNull public java.util.Iterator<E> iterator();
...
@androidx.annotation.RecentlyNullable public java.lang.Object[] toArray();
...
public <T> T[] toArray(@androidx.annotation.RecentlyNullable T[] a);
...
@androidx.annotation.RecentlyNonNull public java.util.ListIterator<E> listIterator();
...
@androidx.annotation.RecentlyNonNull public java.util.ListIterator<E> listIterator(int index);
...
@androidx.annotation.RecentlyNonNull public java.util.List<E> subList(int fromIndex, int toIndex);
...
@androidx.annotation.RecentlyNonNull public default java.util.Spliterator<E> spliterator() { throw new RuntimeException("Stub!"); }
}
