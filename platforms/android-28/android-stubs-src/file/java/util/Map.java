...
@androidx.annotation.RecentlyNullable public V get(@androidx.annotation.RecentlyNullable java.lang.Object key);
...
@androidx.annotation.RecentlyNullable public V put(@androidx.annotation.RecentlyNonNull K key, @androidx.annotation.RecentlyNonNull V value);
...
@androidx.annotation.RecentlyNullable public V remove(@androidx.annotation.RecentlyNullable java.lang.Object key);
...
@androidx.annotation.RecentlyNonNull public java.util.Set<K> keySet();
...
@androidx.annotation.RecentlyNonNull public java.util.Collection<V> values();
...
@androidx.annotation.RecentlyNonNull public java.util.Set<java.util.Map.Entry<K, V>> entrySet();
...
@androidx.annotation.RecentlyNullable public default V getOrDefault(@androidx.annotation.RecentlyNullable java.lang.Object key, @androidx.annotation.RecentlyNullable V defaultValue) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public default V putIfAbsent(@androidx.annotation.RecentlyNonNull K key, @androidx.annotation.RecentlyNonNull V value) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public default V replace(@androidx.annotation.RecentlyNonNull K key, @androidx.annotation.RecentlyNonNull V value) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public default V computeIfAbsent(K key, @androidx.annotation.RecentlyNonNull java.util.function.Function<? super K, ? extends V> mappingFunction) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public default V computeIfPresent(K key, @androidx.annotation.RecentlyNonNull java.util.function.BiFunction<? super K, ? super V, ? extends V> remappingFunction) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public default V compute(K key, @androidx.annotation.RecentlyNonNull java.util.function.BiFunction<? super K, ? super V, ? extends V> remappingFunction) { throw new RuntimeException("Stub!"); }
...
@androidx.annotation.RecentlyNullable public default V merge(K key, @androidx.annotation.RecentlyNonNull V value, @androidx.annotation.RecentlyNonNull java.util.function.BiFunction<? super V, ? super V, ? extends V> remappingFunction) { throw new RuntimeException("Stub!"); }
/**
